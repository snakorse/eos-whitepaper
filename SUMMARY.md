...
* [背景](backgroud.md)
* [区块链应用需求](qu-kuai-lian-ying-yong-xu-qiu/README.md)
...
* [共识算法\(DPOS\)](consensus-algorithm-bft-dpos/README.md)
...
* [账户](accounts/README.md)
  * [操作 & 处理](accounts/actions-and-handlers.md)
  * [基于角色的权限管理](accounts/role-based-permission-management/README.md)
    ...
    * [评估权限](accounts/role-based-permission-management/evaluating-permissions/README.md)
...
* [应用程序的确定性并行执行](deterministic-parallel-execution-of-applications/README.md)
...
* [Token模型与资源使用](token-model-and-resource-usage/README.md)
...
* [治理](governance/README.md)
  ...
  * [更新协议&章程](governance/upgrading-the-protocol-and-constitution/README.md)
    * [紧急变更](governance/upgrading-the-protocol-and-constitution/emergency-changes.md)
* [脚本 & 虚拟机](scripts-and-virtual-machines/README.md)
...
* [跨链通信](inter-blockchain-communication/README.md)
